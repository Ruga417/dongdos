//Copyright t.me/no_name00987bot ( no_name00987 )
...
const token = '8428044515:AAG72aIFKuoz3U7UPyRJUbCKYNNhq_qrYU8';
...
function getPlanLimits(chatId) { 
    ...
    if (userPlan === "SuperVIP") {
        return { planType: "SuperVIP", concurrent: 5, timeLimit: 200 };
...
<b>Hello User, Welcome to Devil Stresser!</b>
Use /help for commands

<b>Provider: Indonesia, Malaysian, Amerika, China, Vietnam, North Korea, Russian, Ukraine</b>`, { parse_mode: 'HTML' });
});
...
bot.onText(/\/help/, (msg) => {
    bot.sendMessage(msg.chat.id, `
<b>Help Command🦇</b>
Contacts: <a href="https://t.me/qwjabjkbot">Owner</a>

<b>/info</b> - <code>user information</code>
<b>/plan</b> - <code>plan price list</code>
<b>/claim</b> - <code>claim plans</code>
<b>/ongoing</b> - <code>attack details</code>
<b>/method</b> - <code>show methods l4/l7</code>
<b>/controlmenu</b> - <code>show control menu</code>
<b>/detect</b> - <code>check website protection</code>
<b>/http</b> - <code>check HTTP response and ping</code>
▬▭▬▭▬▭▬▭▬▭▬▭▬`, { parse_mode: 'HTML' });
});
...
<b>/addown</b> - <code>add owner plan</code>
<b>/delown</b> - <code>delete owner plan</code>
<b>/addsrv</b> - <code>add server connect</code>
<b>/delsrv</b> - <code>delete server connect</code>
<b>/give</b> - <code>give plan</code>
<b>/listuser</b> - <code>show user plan</code>
<b>/listown</b> - <code>show owner plan</code>
<b>/listsrv</b> - <code>check server</code>
<b>/install</b> - <code>install module</code>
<b>/upload</b> - <code>upload file to server</code>
▬▭▬▭▬▭▬▭▬▭▬▭▬
`, { parse_mode: "HTML" });
});
...
bot.onText(/\/plan/, (msg) => {
    ...
    bot.sendMessage(chatId, planMessage, {
        ...
        reply_markup: {
            inline_keyboard: [
                [{ text: "💰 Pay via Dana", callback_data: "pay_dana" }],
                [{ text: "💰 Pay via GoPay", callback_data: "pay_gopay" }],
                [{ text: "💰 Pay via QRIS", callback_data: "pay_qris" }],
                [{ text: "👑 Contact Admin 👑", url: "https://t.me/qwjabjkbot" }]
            ]
        }
    });
});
...
bot.on("callback_query", (query) => {
    ...
    if (data === "pay_dana") {
        paymentMessage = "✅ <b>Payment via Dana</b>\n\n📌 Send to: <code>085641193425</code>\n📝 After the transfer, send the payment proof to the admin.";
    } else if (data === "pay_gopay") {
        paymentMessage = "✅ <b>Payment via GoPay</b>\n\n📌 Send to: <code>085836051197</code>\n📝 After the transfer, send the payment proof to the admin.";
    } else if (data === "pay_qris") {
        paymentMessage = "✅ <b>Payment via QRIS</b>\n\n📌 Scan the QR code (Sent Separately)\n📝 After the transfer, send the payment proof to the admin.";
    }

    bot.sendMessage(chatId, paymentMessage, { parse_mode: "HTML" });
});

// /methods command
bot.onText(/\/method/, (msg) => {
    const chatId = msg.chat.id;
    bot.sendMessage(chatId, `<b>⚒️ List of Methods ⚒️</b>\n\n<pre>` +
    `{\n` +
    `  "Layer 7": {\n` +
    `    "Basic": ["cibi", "pidoras", "flood"],\n` +
    `    "VIP": ["cibi", "glory", "flood", "quantum", "pidoras", "bypass", "thunder", "destroy", "floodvip"],\n` +
    `    "SuperVIP": ["cibi", "glory", "flood", "quantum", "pidoras", "bypass", "destroy", "thunder", "floodvip", "mixbil", "h2-fumi", "h2-devil", "h2-bypass", "h2-flood", "httpcostum"]\n` +
    `  },\n` +
    `  "Layer 4": {\n` +
    `    "Basic": ["tcp", "udp"],\n` +
    `    "VIP": ["tcp", "udp"],\n` +
    `    "SuperVIP": ["tcp", "udp"]\n` +
    `  }\n` +
    `}</pre>\n\n📞 <b>Contact:</b> <a href="https://t.me/qwjabjkbot">Owner</a>`, { parse_mode: "HTML" });
});
...
bot.onText(/\/(flood|glory|cibi|quantum|destroy|pidoras|bypass|thunder|floodvip|mixbil|h2-devil|h2-bypass|h2-fumi|h2-flood|httpcostum) (.+)/, (msg, match) => {
    ...
    const supervipCommands = ["cibi", "glory", "flood", "quantum", "pidoras", "bypass", "destroy", "thunder", "floodvip", "mixbil", "h2-devil", "h2-bypass", "h2-fumi", "h2-flood"];
